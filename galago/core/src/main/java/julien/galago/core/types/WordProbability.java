...
public class WordProbability implements Type<WordProbability> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<WordProbability> {
    ...
    public static class WordOrder implements Order<WordProbability> {
        ...
        public static class ShreddedCombiner implements ReaderSource<WordProbability>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<WordProbability>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            WordProbability last = new WordProbability();
            public julien.galago.tupleflow.Processor<WordProbability> processor;                               
            
            public TupleUnshredder(WordProbability.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<WordProbability> processor) {
                this.processor = processor;
            }
