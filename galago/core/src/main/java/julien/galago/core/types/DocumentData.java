...
public class DocumentData implements Type<DocumentData> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<DocumentData> {
    ...
    public static class Unordered implements Order<DocumentData> {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentData>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<DocumentData>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentData last = new DocumentData();
            public julien.galago.tupleflow.Processor<DocumentData> processor;                               
            
            public TupleUnshredder(DocumentData.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<DocumentData> processor) {
                this.processor = processor;
            }
