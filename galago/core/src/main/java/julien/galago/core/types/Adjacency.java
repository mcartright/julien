...
public class Adjacency implements Type<Adjacency> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<Adjacency> {
    ...
    public static class SourceOrder implements Order<Adjacency> {
        ...
        public static class ShreddedCombiner implements ReaderSource<Adjacency>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<Adjacency>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            Adjacency last = new Adjacency();
            public julien.galago.tupleflow.Processor<Adjacency> processor;                               
            
            public TupleUnshredder(Adjacency.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<Adjacency> processor) {
                this.processor = processor;
            }
