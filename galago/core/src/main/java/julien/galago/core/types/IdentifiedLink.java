...
public class IdentifiedLink implements Type<IdentifiedLink> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<IdentifiedLink> {
    ...
    public static class UrlOrder implements Order<IdentifiedLink> {
        ...
        public static class ShreddedCombiner implements ReaderSource<IdentifiedLink>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<IdentifiedLink>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            IdentifiedLink last = new IdentifiedLink();
            public julien.galago.tupleflow.Processor<IdentifiedLink> processor;                               
            
            public TupleUnshredder(IdentifiedLink.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<IdentifiedLink> processor) {
                this.processor = processor;
            }
