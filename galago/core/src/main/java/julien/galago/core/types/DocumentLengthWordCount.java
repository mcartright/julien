...
public class DocumentLengthWordCount implements Type<DocumentLengthWordCount> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<DocumentLengthWordCount> {
    ...
    public static class DocumentLengthOrder implements Order<DocumentLengthWordCount> {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentLengthWordCount>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<DocumentLengthWordCount>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentLengthWordCount last = new DocumentLengthWordCount();
            public julien.galago.tupleflow.Processor<DocumentLengthWordCount> processor;                               
            
            public TupleUnshredder(DocumentLengthWordCount.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<DocumentLengthWordCount> processor) {
                this.processor = processor;
            }
