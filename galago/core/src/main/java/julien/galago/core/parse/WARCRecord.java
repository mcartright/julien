...
/*
 * Warc Record container
 * 
 * author: mhoy@cs.cmu.edu (Mark J. Hoy)
 * 
 * Modified for Galagosearch by sjh
 * 
 */
...
public class	WARCRecord {
    ...
    private static	byte[] readNextRecord(DataInputStream in, StringBuffer headerBuffer)
        ...
        // If it starts with \r\n, remove it prior to reading content...
        byte CR = in.readByte();
        byte LF = in.readByte();
        if ((CR != 13) && (LF != 10)) {
            retContent[0] = CR;
    ...
    public class	WarcHeader {
        ...
        public		HashMap < String, String > metadata = new HashMap < String,
            String >      ();
    ...
    public WarcHeader warcHeader = new WarcHeader();
