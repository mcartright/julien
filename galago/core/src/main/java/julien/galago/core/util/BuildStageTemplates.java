...
import julien.galago.core.index.disk.FieldIndexWriter;
...
public class BuildStageTemplates {
  ...
  public static Stage getGenericWriteStage(String stageName, File destination, String[] inputs,
           Order[] orders, Class<? extends julien.galago.tupleflow.Step> writer, Parameters p) throws IOException {
    Stage stage = new Stage(stageName);
  ...
  public static Step getParserStep(Parameters p) {
    return getParserStep(p, ParserSelector.class);
  }
