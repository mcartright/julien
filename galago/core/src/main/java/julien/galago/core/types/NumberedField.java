...
public class NumberedField implements Type<NumberedField> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<NumberedField> {
    ...
    public static class FieldNameNumberOrder implements Order<NumberedField> {
        ...
        public static class ShreddedCombiner implements ReaderSource<NumberedField>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<NumberedField>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            NumberedField last = new NumberedField();
            public julien.galago.tupleflow.Processor<NumberedField> processor;                               
            
            public TupleUnshredder(NumberedField.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<NumberedField> processor) {
                this.processor = processor;
            }
