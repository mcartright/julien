...
public class NumberWordPosition implements Type<NumberWordPosition> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<NumberWordPosition> {
    ...
    public static class WordDocumentPositionOrder implements Order<NumberWordPosition> {
        ...
        public static class ShreddedCombiner implements ReaderSource<NumberWordPosition>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<NumberWordPosition>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            NumberWordPosition last = new NumberWordPosition();
            public julien.galago.tupleflow.Processor<NumberWordPosition> processor;                               
            
            public TupleUnshredder(NumberWordPosition.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<NumberWordPosition> processor) {
                this.processor = processor;
            }
