...
public class NumberedLink implements Type<NumberedLink> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<NumberedLink> {
    ...
    public static class SourceOrder implements Order<NumberedLink> {
        ...
        public static class ShreddedCombiner implements ReaderSource<NumberedLink>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<NumberedLink>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            NumberedLink last = new NumberedLink();
            public julien.galago.tupleflow.Processor<NumberedLink> processor;                               
            
            public TupleUnshredder(NumberedLink.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<NumberedLink> processor) {
                this.processor = processor;
            }
