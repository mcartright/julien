...
public class DocumentExtent implements Type<DocumentExtent> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<DocumentExtent> {
    ...
    public static class IdentifierOrder implements Order<DocumentExtent> {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentExtent>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<DocumentExtent>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentExtent last = new DocumentExtent();
            public julien.galago.tupleflow.Processor<DocumentExtent> processor;                               
            
            public TupleUnshredder(DocumentExtent.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<DocumentExtent> processor) {
                this.processor = processor;
            }
