...
public class DocumentValuedExtent implements Type<DocumentValuedExtent> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<DocumentValuedExtent> {
    ...
    public static class IdentifierOrder implements Order<DocumentValuedExtent> {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentValuedExtent>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<DocumentValuedExtent>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentValuedExtent last = new DocumentValuedExtent();
            public julien.galago.tupleflow.Processor<DocumentValuedExtent> processor;                               
            
            public TupleUnshredder(DocumentValuedExtent.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<DocumentValuedExtent> processor) {
                this.processor = processor;
            }
