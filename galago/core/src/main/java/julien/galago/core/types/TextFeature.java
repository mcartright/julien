...
public class TextFeature implements Type<TextFeature> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<TextFeature> {
    ...
    public static class FeatureOrder implements Order<TextFeature> {
        ...
        public static class ShreddedCombiner implements ReaderSource<TextFeature>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<TextFeature>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            TextFeature last = new TextFeature();
            public julien.galago.tupleflow.Processor<TextFeature> processor;                               
            
            public TupleUnshredder(TextFeature.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<TextFeature> processor) {
                this.processor = processor;
            }
