...
public class PREntry implements Type<PREntry> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<PREntry> {
    ...
    public static class DocNumOrder implements Order<PREntry> {
        ...
        public static class ShreddedCombiner implements ReaderSource<PREntry>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<PREntry>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            PREntry last = new PREntry();
            public julien.galago.tupleflow.Processor<PREntry> processor;                               
            
            public TupleUnshredder(PREntry.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<PREntry> processor) {
                this.processor = processor;
            }
