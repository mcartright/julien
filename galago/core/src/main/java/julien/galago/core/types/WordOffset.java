...
public class WordOffset implements Type<WordOffset> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<WordOffset> {
    ...
    public static class WordOrder implements Order<WordOffset> {
        ...
        public static class ShreddedCombiner implements ReaderSource<WordOffset>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<WordOffset>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            WordOffset last = new WordOffset();
            public julien.galago.tupleflow.Processor<WordOffset> processor;                               
            
            public TupleUnshredder(WordOffset.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<WordOffset> processor) {
                this.processor = processor;
            }
