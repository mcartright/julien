...
public class WordDateCount implements Type<WordDateCount> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<WordDateCount> {
    ...
    public static class WordDateOrder implements Order<WordDateCount> {
        ...
        public static class ShreddedCombiner implements ReaderSource<WordDateCount>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<WordDateCount>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            WordDateCount last = new WordDateCount();
            public julien.galago.tupleflow.Processor<WordDateCount> processor;                               
            
            public TupleUnshredder(WordDateCount.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<WordDateCount> processor) {
                this.processor = processor;
            }
