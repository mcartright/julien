...
public class PictureOccurrence implements Type<PictureOccurrence> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<PictureOccurrence> {
    ...
    public static class IdOrdinalTopLeftOrder implements Order<PictureOccurrence> {
        ...
        public static class ShreddedCombiner implements ReaderSource<PictureOccurrence>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<PictureOccurrence>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            PictureOccurrence last = new PictureOccurrence();
            public julien.galago.tupleflow.Processor<PictureOccurrence> processor;                               
            
            public TupleUnshredder(PictureOccurrence.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<PictureOccurrence> processor) {
                this.processor = processor;
            }
