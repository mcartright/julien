...
public class NumberKeyValue implements Type<NumberKeyValue> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<NumberKeyValue> {
    ...
    public static class NumberOrder implements Order<NumberKeyValue> {
        ...
        public static class ShreddedCombiner implements ReaderSource<NumberKeyValue>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<NumberKeyValue>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            NumberKeyValue last = new NumberKeyValue();
            public julien.galago.tupleflow.Processor<NumberKeyValue> processor;                               
            
            public TupleUnshredder(NumberKeyValue.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<NumberKeyValue> processor) {
                this.processor = processor;
            }
