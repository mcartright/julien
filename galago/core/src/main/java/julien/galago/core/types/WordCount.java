...
public class WordCount implements Type<WordCount> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<WordCount> {
    ...
    public static class WordOrder implements Order<WordCount> {
        ...
        public static class ShreddedCombiner implements ReaderSource<WordCount>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<WordCount>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            WordCount last = new WordCount();
            public julien.galago.tupleflow.Processor<WordCount> processor;                               
            
            public TupleUnshredder(WordCount.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<WordCount> processor) {
                this.processor = processor;
            }
