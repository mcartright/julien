...
public class FieldLengthData implements Type<FieldLengthData> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<FieldLengthData> {
    ...
    public static class FieldDocumentOrder implements Order<FieldLengthData> {
        ...
        public static class ShreddedCombiner implements ReaderSource<FieldLengthData>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<FieldLengthData>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            FieldLengthData last = new FieldLengthData();
            public julien.galago.tupleflow.Processor<FieldLengthData> processor;                               
            
            public TupleUnshredder(FieldLengthData.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<FieldLengthData> processor) {
                this.processor = processor;
            }
