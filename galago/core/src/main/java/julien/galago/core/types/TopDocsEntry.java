...
public class TopDocsEntry implements Type<TopDocsEntry> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<TopDocsEntry> {
    ...
    public static class WordDescProbabilityDocumentOrder implements Order<TopDocsEntry> {
        ...
        public static class ShreddedCombiner implements ReaderSource<TopDocsEntry>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<TopDocsEntry>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            TopDocsEntry last = new TopDocsEntry();
            public julien.galago.tupleflow.Processor<TopDocsEntry> processor;                               
            
            public TupleUnshredder(TopDocsEntry.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<TopDocsEntry> processor) {
                this.processor = processor;
            }
