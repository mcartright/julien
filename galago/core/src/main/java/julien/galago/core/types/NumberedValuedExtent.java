...
public class NumberedValuedExtent implements Type<NumberedValuedExtent> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<NumberedValuedExtent> {
    ...
    public static class ExtentNameNumberBeginOrder implements Order<NumberedValuedExtent> {
        ...
        public static class ShreddedCombiner implements ReaderSource<NumberedValuedExtent>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<NumberedValuedExtent>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            NumberedValuedExtent last = new NumberedValuedExtent();
            public julien.galago.tupleflow.Processor<NumberedValuedExtent> processor;                               
            
            public TupleUnshredder(NumberedValuedExtent.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<NumberedValuedExtent> processor) {
                this.processor = processor;
            }
