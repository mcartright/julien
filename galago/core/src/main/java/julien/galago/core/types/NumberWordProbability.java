...
public class NumberWordProbability implements Type<NumberWordProbability> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<NumberWordProbability> {
    ...
    public static class NumberWordOrder implements Order<NumberWordProbability> {
        ...
        public static class ShreddedCombiner implements ReaderSource<NumberWordProbability>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<NumberWordProbability>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            NumberWordProbability last = new NumberWordProbability();
            public julien.galago.tupleflow.Processor<NumberWordProbability> processor;                               
            
            public TupleUnshredder(NumberWordProbability.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<NumberWordProbability> processor) {
                this.processor = processor;
            }
