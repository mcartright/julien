...
public class DocumentNumberWordInteger implements Type<DocumentNumberWordInteger> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<DocumentNumberWordInteger> {
    ...
    public static class Unordered implements Order<DocumentNumberWordInteger> {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentNumberWordInteger>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<DocumentNumberWordInteger>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentNumberWordInteger last = new DocumentNumberWordInteger();
            public julien.galago.tupleflow.Processor<DocumentNumberWordInteger> processor;                               
            
            public TupleUnshredder(DocumentNumberWordInteger.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<DocumentNumberWordInteger> processor) {
                this.processor = processor;
            }
