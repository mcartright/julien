...
public class DocumentField implements Type<DocumentField> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<DocumentField> {
    ...
    public static class IdentifierOrder implements Order<DocumentField> {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentField>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<DocumentField>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentField last = new DocumentField();
            public julien.galago.tupleflow.Processor<DocumentField> processor;                               
            
            public TupleUnshredder(DocumentField.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<DocumentField> processor) {
                this.processor = processor;
            }
