...
public class IndexLink implements Type<IndexLink> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<IndexLink> {
    ...
    public static class SrctypeTargettypeIdTargetidTargetposOrder implements Order<IndexLink> {
        ...
        public static class ShreddedCombiner implements ReaderSource<IndexLink>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<IndexLink>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            IndexLink last = new IndexLink();
            public julien.galago.tupleflow.Processor<IndexLink> processor;                               
            
            public TupleUnshredder(IndexLink.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<IndexLink> processor) {
                this.processor = processor;
            }
