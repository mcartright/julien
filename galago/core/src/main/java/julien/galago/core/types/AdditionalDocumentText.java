...
public class AdditionalDocumentText implements Type<AdditionalDocumentText> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<AdditionalDocumentText> {
    ...
    public static class Unordered implements Order<AdditionalDocumentText> {
        ...
        public static class ShreddedCombiner implements ReaderSource<AdditionalDocumentText>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<AdditionalDocumentText>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            AdditionalDocumentText last = new AdditionalDocumentText();
            public julien.galago.tupleflow.Processor<AdditionalDocumentText> processor;                               
            
            public TupleUnshredder(AdditionalDocumentText.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<AdditionalDocumentText> processor) {
                this.processor = processor;
            }
