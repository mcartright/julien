...
public class DocumentIndicator implements Type<DocumentIndicator> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<DocumentIndicator> {
        public void process(DocumentIndicator object) throws IOException;
        public void close() throws IOException;
    }                        
    public interface Source extends Step {
    }
    public static class DocumentOrder implements Order<DocumentIndicator> {
        ...
        public static class OrderedWriterClass extends OrderedWriter< DocumentIndicator > {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentIndicator>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<DocumentIndicator>) processor));
                } else {
        ...
        public static class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<DocumentIndicator>, ShreddedSource {      
            public ShreddedProcessor processor;
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentIndicator last = new DocumentIndicator();
            public julien.galago.tupleflow.Processor<DocumentIndicator> processor;                               
            
            public TupleUnshredder(DocumentIndicator.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<DocumentIndicator> processor) {
                this.processor = processor;
            }
