...
public class ExtractedLink implements Type<ExtractedLink> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<ExtractedLink> {
    ...
    public static class DestUrlOrder implements Order<ExtractedLink> {
        ...
        public static class ShreddedCombiner implements ReaderSource<ExtractedLink>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<ExtractedLink>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            ExtractedLink last = new ExtractedLink();
            public julien.galago.tupleflow.Processor<ExtractedLink> processor;                               
            
            public TupleUnshredder(ExtractedLink.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<ExtractedLink> processor) {
                this.processor = processor;
            }
