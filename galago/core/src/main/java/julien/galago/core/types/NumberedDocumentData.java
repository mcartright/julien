...
public class NumberedDocumentData implements Type<NumberedDocumentData> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<NumberedDocumentData> {
    ...
    public static class NumberOrder implements Order<NumberedDocumentData> {
        ...
        public static class ShreddedCombiner implements ReaderSource<NumberedDocumentData>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<NumberedDocumentData>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            NumberedDocumentData last = new NumberedDocumentData();
            public julien.galago.tupleflow.Processor<NumberedDocumentData> processor;                               
            
            public TupleUnshredder(NumberedDocumentData.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<NumberedDocumentData> processor) {
                this.processor = processor;
            }
