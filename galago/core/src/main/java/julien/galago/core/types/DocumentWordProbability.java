...
public class DocumentWordProbability implements Type<DocumentWordProbability> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<DocumentWordProbability> {
    ...
    public static class DocumentWordOrder implements Order<DocumentWordProbability> {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentWordProbability>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<DocumentWordProbability>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentWordProbability last = new DocumentWordProbability();
            public julien.galago.tupleflow.Processor<DocumentWordProbability> processor;                               
            
            public TupleUnshredder(DocumentWordProbability.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<DocumentWordProbability> processor) {
                this.processor = processor;
            }
