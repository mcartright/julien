...
public class DocumentWordPosition implements Type<DocumentWordPosition> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<DocumentWordPosition> {
    ...
    public static class DocumentOrder implements Order<DocumentWordPosition> {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentWordPosition>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<DocumentWordPosition>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentWordPosition last = new DocumentWordPosition();
            public julien.galago.tupleflow.Processor<DocumentWordPosition> processor;                               
            
            public TupleUnshredder(DocumentWordPosition.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<DocumentWordPosition> processor) {
                this.processor = processor;
            }
