...
public class KeyValuePair implements Type<KeyValuePair> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<KeyValuePair> {
    ...
    public static class KeyOrder implements Order<KeyValuePair> {
        ...
        public static class ShreddedCombiner implements ReaderSource<KeyValuePair>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<KeyValuePair>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            KeyValuePair last = new KeyValuePair();
            public julien.galago.tupleflow.Processor<KeyValuePair> processor;                               
            
            public TupleUnshredder(KeyValuePair.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<KeyValuePair> processor) {
                this.processor = processor;
            }
