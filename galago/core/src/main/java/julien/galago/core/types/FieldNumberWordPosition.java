...
public class FieldNumberWordPosition implements Type<FieldNumberWordPosition> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<FieldNumberWordPosition> {
    ...
    public static class FieldWordDocumentPositionOrder implements Order<FieldNumberWordPosition> {
        ...
        public static class ShreddedCombiner implements ReaderSource<FieldNumberWordPosition>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<FieldNumberWordPosition>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            FieldNumberWordPosition last = new FieldNumberWordPosition();
            public julien.galago.tupleflow.Processor<FieldNumberWordPosition> processor;                               
            
            public TupleUnshredder(FieldNumberWordPosition.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<FieldNumberWordPosition> processor) {
                this.processor = processor;
            }
