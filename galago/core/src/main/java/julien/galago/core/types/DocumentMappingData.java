...
public class DocumentMappingData implements Type<DocumentMappingData> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<DocumentMappingData> {
    ...
    public static class IndexIdOrder implements Order<DocumentMappingData> {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentMappingData>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<DocumentMappingData>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentMappingData last = new DocumentMappingData();
            public julien.galago.tupleflow.Processor<DocumentMappingData> processor;                               
            
            public TupleUnshredder(DocumentMappingData.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<DocumentMappingData> processor) {
                this.processor = processor;
            }
