...
public class DocumentFeature implements Type<DocumentFeature> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<DocumentFeature> {
    ...
    public static class DocumentOrder implements Order<DocumentFeature> {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentFeature>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<DocumentFeature>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentFeature last = new DocumentFeature();
            public julien.galago.tupleflow.Processor<DocumentFeature> processor;                               
            
            public TupleUnshredder(DocumentFeature.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<DocumentFeature> processor) {
                this.processor = processor;
            }
