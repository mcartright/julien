...
public class HalfNumberedLink implements Type<HalfNumberedLink> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<HalfNumberedLink> {
    ...
    public static class DestOrder implements Order<HalfNumberedLink> {
        ...
        public static class ShreddedCombiner implements ReaderSource<HalfNumberedLink>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<HalfNumberedLink>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            HalfNumberedLink last = new HalfNumberedLink();
            public julien.galago.tupleflow.Processor<HalfNumberedLink> processor;                               
            
            public TupleUnshredder(HalfNumberedLink.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<HalfNumberedLink> processor) {
                this.processor = processor;
            }
