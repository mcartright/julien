...
public class NumberWordCount implements Type<NumberWordCount> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<NumberWordCount> {
    ...
    public static class DocumentOrder implements Order<NumberWordCount> {
        ...
        public static class ShreddedCombiner implements ReaderSource<NumberWordCount>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<NumberWordCount>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            NumberWordCount last = new NumberWordCount();
            public julien.galago.tupleflow.Processor<NumberWordCount> processor;                               
            
            public TupleUnshredder(NumberWordCount.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<NumberWordCount> processor) {
                this.processor = processor;
            }
