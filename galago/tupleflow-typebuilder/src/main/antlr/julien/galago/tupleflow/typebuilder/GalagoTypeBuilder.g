...
@header {
  ...
  import julien.galago.tupleflow.typebuilder.OrderSpecification;
  import julien.galago.tupleflow.typebuilder.OrderedFieldSpecification;
  import julien.galago.tupleflow.typebuilder.Direction;
  import julien.galago.tupleflow.typebuilder.FieldSpecification;
}
