...
public class TemplateTypeBuilder {
  ...
  public TemplateTypeBuilder(TypeSpecification spec) {
    CommonGroupLoader loader = new CommonGroupLoader("julien/galago/tupleflow/templates", null);
  ...
  public static void main(String[] args) throws java.lang.Exception {
    if (args.length < 1) {
      System.err.println(
              "Usage: java julien.galago.tupleflow.typebuilder.TemplateTypeBuilder"
              + " <galago type files>");
      System.exit(0);
    }
    ...
    for (File f : files) {
      if (f.isFile() && f.getName().endsWith("galagotype")) {
        ...
        String comment =
                ...
                + "//     java julien.galago.tupleflow.typebuilder.TypeBuilderTemplate ...\n";
