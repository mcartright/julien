 ...
 * @author trevor
 */
@OutputClass(className = "julien.galago.tupleflow.types.FileName", order = {"+filename"})
        ...
        if (parameters.getJSON().containsKey("directory")) {
            ...
            for (String directory : directories) {
                ...
                if (directoryFile.exists() == false) {
                    ...
                    store.addError(directoryFile.toString() + " exists, but it isn't a directory.");
                }
            }
        }
        if (parameters.getJSON().containsKey("filename")) {
            ...
            for (String file : files) {
                ...
                if (f.exists() == false) {
                    ...
                    store.addError(file + " exists, but isn't a file.");
                }
            }
        }
    }
