...
public class SerializedParameters implements Type<SerializedParameters> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<SerializedParameters> {
    ...
    public static class ParametersOrder implements Order<SerializedParameters> {
        ...
        public static class ShreddedCombiner implements ReaderSource<SerializedParameters>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<SerializedParameters>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            SerializedParameters last = new SerializedParameters();
            public julien.galago.tupleflow.Processor<SerializedParameters> processor;                               
            
            public TupleUnshredder(SerializedParameters.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<SerializedParameters> processor) {
                this.processor = processor;
            }
