...
public class TupleflowInt implements Type<TupleflowInt> {
    public int value; 
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<TupleflowInt> {
        public void process(TupleflowInt object) throws IOException;
        public void close() throws IOException;
    }                        
    public interface Source extends Step {
    }
    public static class ValueOrder implements Order<TupleflowInt> {
        ...
        public static class OrderedWriterClass extends OrderedWriter< TupleflowInt > {
        ...
        public static class ShreddedCombiner implements ReaderSource<TupleflowInt>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<TupleflowInt>) processor));
                } else {
        ...
        public static class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<TupleflowInt>, ShreddedSource {      
            public ShreddedProcessor processor;
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            TupleflowInt last = new TupleflowInt();
            public julien.galago.tupleflow.Processor<TupleflowInt> processor;                               
            
            public TupleUnshredder(TupleflowInt.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<TupleflowInt> processor) {
                this.processor = processor;
            }
