...
public class XMLFragment implements Type<XMLFragment> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<XMLFragment> {
    ...
    public static class NodePathOrder implements Order<XMLFragment> {
        ...
        public static class ShreddedCombiner implements ReaderSource<XMLFragment>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<XMLFragment>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            XMLFragment last = new XMLFragment();
            public julien.galago.tupleflow.Processor<XMLFragment> processor;                               
            
            public TupleUnshredder(XMLFragment.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<XMLFragment> processor) {
                this.processor = processor;
            }
