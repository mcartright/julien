...
public class FileName implements Type<FileName> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<FileName> {
    ...
    public static class FilenameOrder implements Order<FileName> {
        ...
        public static class ShreddedCombiner implements ReaderSource<FileName>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<FileName>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            FileName last = new FileName();
            public julien.galago.tupleflow.Processor<FileName> processor;                               
            
            public TupleUnshredder(FileName.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<FileName> processor) {
                this.processor = processor;
            }
