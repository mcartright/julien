...
public class TupleflowBytes implements Type<TupleflowBytes> {
    public byte[] value; 
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<TupleflowBytes> {
        public void process(TupleflowBytes object) throws IOException;
        public void close() throws IOException;
    }                        
    public interface Source extends Step {
    }
    public static class ValueOrder implements Order<TupleflowBytes> {
        ...
        public static class OrderedWriterClass extends OrderedWriter< TupleflowBytes > {
        ...
        public static class ShreddedCombiner implements ReaderSource<TupleflowBytes>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<TupleflowBytes>) processor));
                } else {
        ...
        public static class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<TupleflowBytes>, ShreddedSource {      
            public ShreddedProcessor processor;
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            TupleflowBytes last = new TupleflowBytes();
            public julien.galago.tupleflow.Processor<TupleflowBytes> processor;                               
            
            public TupleUnshredder(TupleflowBytes.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<TupleflowBytes> processor) {
                this.processor = processor;
            }
