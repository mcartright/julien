...
public class TupleflowString implements Type<TupleflowString> {
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<TupleflowString> {
    ...
    public static class ValueOrder implements Order<TupleflowString> {
        ...
        public static class ShreddedCombiner implements ReaderSource<TupleflowString>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<TupleflowString>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            TupleflowString last = new TupleflowString();
            public julien.galago.tupleflow.Processor<TupleflowString> processor;                               
            
            public TupleUnshredder(TupleflowString.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<TupleflowString> processor) {
                this.processor = processor;
            }
