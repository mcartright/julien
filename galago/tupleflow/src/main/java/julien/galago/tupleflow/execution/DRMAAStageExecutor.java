...
public class DRMAAStageExecutor extends RemoteStageExecutor {
  ...
  public String className = "julien.galago.tupleflow.execution.LocalStageExecutor";
  ...
  public StageExecutionStatus submit(String stageName, ArrayList<String> jobPaths,
	...
	System.out.println(String.format("Found 'java.class.path' property as: %s", classPath));
