...
public class TupleflowDouble implements Type<TupleflowDouble> {
    public double value; 
    ...
    public interface Processor extends Step, julien.galago.tupleflow.Processor<TupleflowDouble> {
        public void process(TupleflowDouble object) throws IOException;
        public void close() throws IOException;
    }                        
    public interface Source extends Step {
    }
    public static class ValueOrder implements Order<TupleflowDouble> {
        ...
        public static class OrderedWriterClass extends OrderedWriter< TupleflowDouble > {
        ...
        public static class ShreddedCombiner implements ReaderSource<TupleflowDouble>, ShreddedSource {   
            ...
            public Step setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((julien.galago.tupleflow.Processor<TupleflowDouble>) processor));
                } else {
        ...
        public static class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<TupleflowDouble>, ShreddedSource {      
            public ShreddedProcessor processor;
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            TupleflowDouble last = new TupleflowDouble();
            public julien.galago.tupleflow.Processor<TupleflowDouble> processor;                               
            
            public TupleUnshredder(TupleflowDouble.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(julien.galago.tupleflow.Processor<TupleflowDouble> processor) {
                this.processor = processor;
            }
